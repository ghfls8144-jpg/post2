  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "안녕하세요! 저는 포스트팁스 사업비 집행 및 협약변경 전문 AI입니다. 📋\n\n다음 세 가지 공식 문서를 기반으로 답변드립니다:\n① 중소기업창업 지원사업 통합관리지침 (2025.12.23 개정)\n② 2025년 포스트팁스 사업비 집행기준 및 절차 교육자료\n③ 포스트팁스 협약변경 절차 및 사업비 유의사항 안내 (2025.10.27)\n\n비목별 집행 기준, 필수 증빙서류, 협약변경 절차, 사전승인 방법 등 궁금하신 사항을 편하게 물어보세요!",
    },
  ]);
      ...
      <div style={styles.page}>
        ...
        <header style={styles.header}>
          <div style={styles.headerInner}>
            ...
            <div>
              <div style={styles.headerTitle}>창업지원사업 사업비 집행 AI</div>
              <div style={styles.headerSub}>통합관리지침 + 집행기준 + 협약변경 절차 · 2025년 최신</div>
            </div>
        ...
        <div style={styles.chatWrap}>
          ...
          <div style={styles.inputArea}>
            ...
            <p style={styles.footer}>
              통합관리지침 + 포스트팁스 집행기준 + 협약변경 절차 · 2025년 최신
            </p>
          </div>
        </div>
